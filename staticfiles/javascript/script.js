...
if(login_button != null) {
    ...
    login_button.addEventListener('click', () => {
        ...
        const login_menu = document.createElement("div");
        login_menu.id = "login_menu";
        let w = max(min(window.innerWidth*0.25, 500), 150);
        login_menu.style.width = "calc(clamp(150px, 25vw, 500px)*1.25)";
        login_menu.style.height = "clamp(150px, 25vw, 500px)";
        login_menu.style.backgroundColor = "var(--color_mediumBg)";
        login_menu.style.borderRadius = "3vw";
        login_menu.innerHTML = '<form class="login-form" action="/login" method="POST"><label for="username">Username</label><input type="text" id="username" name="username" placeholder="Enter your username" required><label for="password">Password</label><input type="password" id="password" name="password" placeholder="Enter your password" required><button type="submit">Log In</button><a href="#" class="forgot-password">Forgot your password?</a></form>';
